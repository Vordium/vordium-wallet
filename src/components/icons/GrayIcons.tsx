// Light Gray SVG Icons for Professional Dark Theme
...
// Bell/Notification Icon - Professional bell design
...
// Send Icon - Arrow pointing up (outgoing)
...
// Receive Icon - Arrow pointing down (incoming)
export const ReceiveIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 5v14m0 0l7-7m-7 7l-7-7" />
  </svg>
);

// Buy Icon - Dollar sign (cash icon)
...
// Alert Triangle Icon - Warning/Danger
...
// External Link Icon - Open in explorer
...
// Arrow Up Icon - Send/Outgoing
export const ArrowUpIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 14l3-3 3 3m0 0l3-3m-3 3V8" />
  </svg>
);

// Arrow Down Icon - Receive/Incoming
export const ArrowDownIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 10l-3 3-3-3m0 0l-3 3m3-3v6" />
  </svg>
);

// Trending Up Icon - Gains/Positive
...
// Trending Down Icon - Losses/Negative
...
// Arrow Up Down Icon - Swap/Exchange
export const ArrowUpDownIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
