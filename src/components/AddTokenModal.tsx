      ...
      <div className="bg-gray-800 rounded-3xl max-w-lg w-full max-h-[90vh] overflow-hidden shadow-2xl">
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="border-t-2 border-gray-600 pt-6">
            <h3 className="font-bold text-white mb-4">Add Custom Token</h3>
            ...
            <input
              ...
              className="w-full px-4 py-4 text-white bg-gray-700 border-2 border-gray-600 rounded-xl font-mono text-sm mb-4 focus:border-gray-500 focus:ring-4 focus:ring-gray-500"
            />

            <button
              onClick={handleAddCustomToken}
              disabled={!customAddress || searching}
              className="w-full py-4 bg-gradient-to-r from-gray-600 to-gray-700 text-white font-bold rounded-xl hover:from-gray-500 hover:to-gray-600 disabled:from-gray-800 disabled:to-gray-800 transition flex items-center justify-center gap-2"
            >
